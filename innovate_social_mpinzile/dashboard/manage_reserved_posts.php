...
// Retrieve user's reserved posts
$postsQuery = "SELECT * FROM reserved_posts WHERE user_id = ?";
...
<header class="bg-primary text-white text-center py-3">
    <h1 class="display-5">Manage Your Reserved Posts</h1>
</header>
        ...
        <div class="col-md-8 offset-md-2">
                ...
                <?php while ($post = $postsResult->fetch_assoc()) : ?>
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Will be Posted on <?php echo $post['post_date']; ?> at <?php echo $post['post_time']; ?></p>
                            <div class="btn-group">
            ...
            <?php else : ?>
                <div class="alert alert-info" role="alert">
                    You do not have any reserved posts yet. <a href="reserve_post.php">Reserve a post</a>.
                </div>
            <?php endif; ?>
        </div>
    </div>
